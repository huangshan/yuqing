        ...
        <div class="span12">
            <div class="widget-box">
                ...
                <div class="widget-content nopadding">
                    <form id="pwdform" class="form-horizontal" action="__ROOT__/index.php/SystemManage/save/model/users" method="post">
                    <div class="control-group">
                        <label class="control-label">
                            账户
                        </label>
                        <div class="controls">
                            <input type="text" disabled="disabled" name="Account" value="<?php echo ($list["Account"]); ?>" />
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label">
                        ...
                        <div class="controls">
                            <input type="text" placeholder="" name="Name"  value="<?php echo ($list["Name"]); ?>"  />
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" placeholder="" value="<?php echo ($list["Mobile"]); ?>"  name="Mobile" />
                        </div>
                    </div>
                    <div class="control-group">
                        <label class="control-label">
                        ...
                        <div class="controls">
                            <input type="text" placeholder="例 mail@gmail.com"  value="<?php echo ($list["Email"]); ?>" name="Email"/>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input  name="Status"  type="checkbox"  <?php if($list['Status']==1){echo "checked";} ?>  />
                        </div>
                    </div>
